...
class BusinessIntelligencePipeline:
    ...
    def __init__(self, base_dir: Optional[str] = None):
        ...
        for directory in [self.charts_dir, self.reports_dir, self.models_dir, self.output_dir]:
    ...
    def run(
        ...
        # 4. Resolve Logo Path Safely
        logo_path = os.path.abspath(
            os.path.join(self.base_dir, "../../../frontend/assets/madukai_logo.png")
        )
