...
class InsightGenerator:
    ...
    def generate_insights(
        ...
        gross_margin_raw = dashboard_metrics.get('gross_margin')
        gross_margin = float(gross_margin_raw) if gross_margin_raw is not None else None
        
        churn_rate = float(dashboard_metrics.get('churn_rate', 0.0) or 0.0)
        ...
        # 6. Optional LLM Refinement Guard
