...
class ReportGenerator:
    """Renders HTML executive reports and compiles them into PDF documents cleanly."""
    ...
    def __init__(self, template_dir: Optional[str] = None):
        ...
        # Custom filters that properly display N/A for missing metrics rather than zeroing out
        ...
        self.env.filters['pct'] = pct_filter
    ...
    def compile_pdf(self, html_content: str, output_path: str) -> str:
        ...
        try:
            ...
            logger.warning(f"No PDF rendering engine available. Saved HTML fallback report to '{fallback_html_path}'.")
